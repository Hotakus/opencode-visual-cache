...
const ZH_T = {
  ...
  sectionShown: "{s} 已显示",
  sectionHidden: "{s} 已隐藏",
  bottomRestartOn: "底部状态栏已开启，重启 TUI 后生效",
  bottomRestartOff: "底部状态栏已关闭，重启 TUI 后生效",
...
const EN_T: Translation = {
  ...
  bottomRestartOn: "Bottom bar enabled; restart the TUI to apply",
  bottomRestartOff: "Bottom bar disabled; restart the TUI to apply",
...
const JA_T: Translation = {
  ...
  sectionShown: "{s} 表示",
  sectionHidden: "{s} 非表示",
  bottomRestartOn: "下部ステータスバーを有効化しました。TUI 再起動後に反映されます",
  bottomRestartOff: "下部ステータスバーを無効化しました。TUI 再起動後に反映されます",
...
const KO_T: Translation = {
  ...
  sectionShown: "{s} 표시",
  sectionHidden: "{s} 숨김",
  bottomRestartOn: "하단 상태바를 켰습니다. TUI 재시작 후 적용됩니다",
  bottomRestartOff: "하단 상태바를 껐습니다. TUI 재시작 후 적용됩니다",
