...
const ZH_T = {
  ...
  sectionShown: "{s} 已显示",
  sectionHidden: "{s} 已隐藏",
  bottomRestartHint: "底部状态栏重启 TUI 后完全生效；关闭可让出输入框槽位",
...
const EN_T: Translation = {
  ...
  bottomRestartHint: "Bottom bar takes full effect after a TUI restart; disable it to yield the prompt slot",
...
const JA_T: Translation = {
  ...
  sectionShown: "{s} 表示",
  sectionHidden: "{s} 非表示",
  bottomRestartHint: "下部ステータスバーは TUI 再起動後に完全反映。無効にすると入力欄スロットを譲ります",
...
const KO_T: Translation = {
  ...
  sectionShown: "{s} 표시",
  sectionHidden: "{s} 숨김",
  bottomRestartHint: "하단 상태바는 TUI 재시작 후 완전히 적용됩니다. 비활성화하면 입력창 슬롯을 양보합니다",
